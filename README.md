  ...
  2. API
    <ol> API desenvolvida em python com a biblioteca FASTAPI com as seguintes rotas
      <li>a. http://localhost:8000/times/ </li>
        1. Método GET: Podemos solicitar todos os times cadastrados no banco de dados e com a extensão "?search=PALAVRA" naM URL podemos pesquisar por times especificos com a "palavra" como nome
